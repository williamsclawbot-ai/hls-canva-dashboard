...
// Data storage paths - use /tmp for serverless environment
...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', service: 'HLS Canva Automation API', environment: process.env.NODE_ENV });
});
...
app.post('/publish/instagram', (req, res) => {
  try {
